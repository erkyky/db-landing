    ...
    <main className="relative flex min-h-screen flex-col">
      <BeamsBackground intensity="subtle" className="flex-1 flex flex-col">
        ...
        <HeroSection
          ...
          descriptions={[
            "Deepblue Capital Partners is a forward-thinking private equity firm with 25 years of combined expertise,",
            "identifying strategic real estate opportunities across diverse asset classes.",
          ]}
