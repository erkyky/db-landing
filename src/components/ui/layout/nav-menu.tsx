...
export default function NavMenu() {
  ...
  const baseTrigger =
    "font-sans uppercase tracking-[0.12em] whitespace-nowrap transition-colors duration-300 text-[clamp(14px,0.95vw,20px)]";
                            ...
                            >
                              {dropdownChildren(item).map((child) => (
                                ...
                                >
                                  ...
                                  />
                                  <span className="font-sans uppercase tracking-[0.12em] text-[clamp(11px,0.78vw,14px)] text-white transition-colors duration-300 ease-out group-hover:text-[#cca885]">
                                    {child.label}
                                  </span>
                                </motion.a>
                              ))}
                  ...
                  {hasChildren ? (
                    ...
                    <div className="flex w-full items-center justify-between">
                      <a
                        href={item.href}
                        onClick={closeMobile}
                        className={`flex-1 py-4 font-sans uppercase tracking-[0.12em] text-[clamp(1.1rem,5.5vw,1.6rem)] transition-colors ${active ? "text-[#cca885]" : "text-white hover:text-[#cca885]"}`}
                      >
                        {item.label}
                      </a>
                      <button
                    ...
                    <a
                      href={item.href}
                      onClick={closeMobile}
                      className={`block py-4 font-sans uppercase tracking-[0.12em] text-[clamp(1.1rem,5.5vw,1.6rem)] transition-colors ${active ? "text-[#cca885]" : "text-white hover:text-[#cca885]"}`}
                    >
                      {item.label}
                    </a>
                  )}
                          ...
                          <div className="flex flex-col gap-1 pb-4 pl-1">
                            {dropdownChildren(item).map((child) => (
                              ...
                              >
                                ...
                                />
                                <span className="font-sans uppercase tracking-[0.12em] text-[clamp(0.85rem,4vw,1.05rem)] text-white/75 transition-colors group-hover:text-[#cca885]">
                                  {child.label}
                                </span>
                              </a>
                            ))}
